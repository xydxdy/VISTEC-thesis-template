...
%----- Publications style 1 (Manual)-------------%
% Disable auto numbering for publications
...
%----- Publications style 2 (Auto)-------------%
% Enable auto numbering for publications

% \toggletrue{showrefnumber}
% \noindent\textbf{Academic Publication:}\\[1em]
% \noindent\fullcite{id3} \\
% \noindent\fullcite{id5} \\
