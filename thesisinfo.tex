...
%----- Thesis Title -----
\title{VISTEC Thesis Template:\linebreak[2] A Complete LaTeX Thesis Preparation Version 1}
%% Add \linebreak[2] to allow an aesthetic line break if the layout requires it
