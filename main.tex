...
%% Compiler: pdfLaTeX
%% Packages: TeX Live version 2024
...
%% Solve "Overfull \hbox" warnings by customizing hyphenation rules
%% Use this when the default hyphenation is imperfect
\hyphenation{neurorehabi-litation} %% See result on page 1
\hyphenation{inherent} %% See result on page 1
